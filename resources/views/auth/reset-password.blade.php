...
<head>
    ...
    <title>Deep Sync - Redefinir Senha</title>
...
<div class="login-container">
    ...
    <div class="card">
        <div class="card-header">
            <h3><i class="fas fa-shield-alt mr-2"></i>Redefinir Senha</h3>
        </div>
        <div class="card-body">
            <p class="info-text">
                Digite sua nova senha abaixo. Certifique-se de criar uma senha forte e segura.
            </p>
            ...
            <form action="{{ route('password.store') }}" method="post">
                ...
                <div class="password-requirements">
                    <h6><i class="fas fa-info-circle mr-1"></i>Requisitos da senha:</h6>
                    <ul>
