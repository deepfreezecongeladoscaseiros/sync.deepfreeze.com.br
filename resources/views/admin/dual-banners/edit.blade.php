...
@section('title', 'Editar Par de Banners')

@section('content_header')
    <h1>Editar Par de Banners Duplos</h1>
@stop

@section('content')
    <form action="{{ route('admin.dual-banners.update', $dualBanner) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                           ...
                                           id="order"
                                           name="order"
                                           value="{{ old('order', $dualBanner->order) }}"
                                           min="1"
                                           >
                                    @error('order')
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch mt-4">
                                        <input type="checkbox"
                                               ...
                                               name="active"
                                               value="1"
                                               {{ old('active', $dualBanner->active) ? 'checked' : '' }}>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="left_image">Imagem </label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url"
                                   ...
                                   id="left_link"
                                   name="left_link"
                                   value="{{ old('left_link', $dualBanner->left_link) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="left_alt_text"
                                   name="left_alt_text"
                                   value="{{ old('left_alt_text', $dualBanner->left_alt_text) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                           ...
                                           value="{{ old('left_start_date', $dualBanner->left_start_date?->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                           ...
                                           id="left_end_date"
                                           name="left_end_date"
                                           value="{{ old('left_end_date', $dualBanner->left_end_date?->format('Y-m-d')) }}">
                                    @error('left_end_date')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
            ...
            <div class="col-md-6">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="right_image">Imagem </label>
                            <div class="custom-file">
                                <input type="file"
                        ...
                        <div class="form-group">
                            ...
                            <input type="url"
                                   ...
                                   id="right_link"
                                   name="right_link"
                                   value="{{ old('right_link', $dualBanner->right_link) }}"
                                   placeholder="https://exemplo.com/pagina">
                            @error('right_link')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="right_alt_text"
                                   name="right_alt_text"
                                   value="{{ old('right_alt_text', $dualBanner->right_alt_text) }}"
                                   placeholder="Descrição da imagem para SEO">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                           ...
                                           value="{{ old('right_start_date', $dualBanner->right_start_date?->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                           ...
                                           id="right_end_date"
                                           name="right_end_date"
                                           value="{{ old('right_end_date', $dualBanner->right_end_date?->format('Y-m-d')) }}">
